...
export default function Header(){
    return(
        ...
        <img src="src/assets/header-img.gif" alt="Desk with houseplants on left and computer monitor and lamp on right" className='w-full h-full' />
            ...
            sm:mt-8 sm:mr-40 sm:pr-4 sm:text-5xs 
            md:mt-18 md:mr-64 md:pr-4 md:text-4xs 
            lg:mt-18 lg:mr-80 lg:pr-7 lg:text-3xs 
            xl:mt-24 xl:mr-96 xl:pr-10 xl:text-xxs">Trainee Software Engineer</h2>
        </div>
        </>
    )
}